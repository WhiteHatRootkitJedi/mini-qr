...
export const pabiblePreset: Preset = {
  ...defaultPresetOptions,
  name: 'PA Bible',
  url: 'https://pabibletf.org/',
  data: 'https://qr.pabibletf.org/',
  image:
  ...
  height: 200,
  margin: 0,
  dotsOptions: { color: '#2d433e', type: 'classy' },
  cornersSquareOptions: { color: '#000000', type: 'extra-rounded' },
  cornersDotOptions: { color: '#2d433e', type: 'dot'},
  style: { borderRadius: '12px', background: '#ffffff' },
  imageOptions: { margin:-12 }
}
